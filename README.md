...
Models are sorted in descending order based on Accuracy.
...
| Gaussian Naive Bayes   | 0.9282   | 0.9543    | 0.9282    | 0.9282 | 0.9282   | 0.8562    |
...
| K-Nearest Neighbors      | Achieved very high accuracy and perfect AUC. Performance indicates that similar feature patterns strongly cluster together in the dataset. Slightly sensitive to local variations. |
...
| Gaussian Naive Bayes     | Recorded the lowest performance among all models. The independence assumption between features likely limited its effectiveness for this dataset. |
